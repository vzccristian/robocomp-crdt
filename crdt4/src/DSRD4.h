...
class DSRD4checker : public virtual ::Ice::Object
{
public:

    using ProxyType = DSRD4checkerPrx;
...
class DSRD4checkerPrx : public virtual ::Ice::Proxy<DSRD4checkerPrx, ::Ice::ObjectPrx>
{
public:

    void finish(const ::std::string& iceP_name, const ::Ice::Context& context = Ice::noExplicitContext)
    {
        _makePromiseOutgoing<void>(true, this, &RoboCompDSRD4::DSRD4checkerPrx::_iceI_finish, iceP_name, context).get();
    }
    ...
    auto finishAsync(const ::std::string& iceP_name, const ::Ice::Context& context = Ice::noExplicitContext)
        -> decltype(::std::declval<P<void>>().get_future())
    {
        return _makePromiseOutgoing<void, P>(false, this, &RoboCompDSRD4::DSRD4checkerPrx::_iceI_finish, iceP_name, context);
    }
    ...
    finishAsync(const ::std::string& iceP_name,
                ...
                const ::Ice::Context& context = Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &RoboCompDSRD4::DSRD4checkerPrx::_iceI_finish, iceP_name, context);
    }
...
protected:
    ...
    DSRD4checkerPrx() = default;
    friend ::std::shared_ptr<DSRD4checkerPrx> IceInternal::createProxy<DSRD4checkerPrx>();
...
using DSRD4checkerPtr = ::std::shared_ptr<DSRD4checker>;
using DSRD4checkerPrxPtr = ::std::shared_ptr<DSRD4checkerPrx>;
...
class DSRD4checker;
void _readProxy(::Ice::InputStream*, ::IceInternal::ProxyHandle< ::IceProxy::RoboCompDSRD4::DSRD4checker>&);
::IceProxy::Ice::Object* upCast(::IceProxy::RoboCompDSRD4::DSRD4checker*);
...
class DSRD4checker;
::Ice::Object* upCast(::RoboCompDSRD4::DSRD4checker*);
typedef ::IceInternal::Handle< ::RoboCompDSRD4::DSRD4checker> DSRD4checkerPtr;
typedef ::IceInternal::ProxyHandle< ::IceProxy::RoboCompDSRD4::DSRD4checker> DSRD4checkerPrx;
typedef DSRD4checkerPrx DSRD4checkerPrxPtr;
void _icePatchObjectPtr(DSRD4checkerPtr&, const ::Ice::ObjectPtr&);
...
class Callback_DSRD4checker_finish_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_DSRD4checker_finish_Base> Callback_DSRD4checker_finishPtr;
...
class DSRD4checker : public virtual ::Ice::Proxy<DSRD4checker, ::IceProxy::Ice::Object>
{
public:
    ...
    ::Ice::AsyncResultPtr begin_finish(const ::std::string& iceP_name, const ::RoboCompDSRD4::Callback_DSRD4checker_finishPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_finish(iceP_name, ::Ice::noExplicitContext, del, cookie);
    }

    ::Ice::AsyncResultPtr begin_finish(const ::std::string& iceP_name, const ::Ice::Context& context, const ::RoboCompDSRD4::Callback_DSRD4checker_finishPtr& del, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_finish(iceP_name, context, del, cookie);
    }
...
public:
    ...
    typedef DSRD4checkerPrx ProxyType;
    typedef DSRD4checkerPtr PointerType;

    virtual ~DSRD4checker();
...
inline bool operator==(const DSRD4checker& lhs, const DSRD4checker& rhs)
{
    return static_cast<const ::Ice::Object&>(lhs) == static_cast<const ::Ice::Object&>(rhs);
}
...
template<class T>
class CallbackNC_DSRD4checker_finish : public Callback_DSRD4checker_finish_Base, public ::IceInternal::OnewayCallbackNC<T>
{
public:
    ...
    CallbackNC_DSRD4checker_finish(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallbackNC<T>(obj, cb, excb, sentcb)
    {
    }
};

template<class T> Callback_DSRD4checker_finishPtr
newCallback_DSRD4checker_finish(const IceUtil::Handle<T>& instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_DSRD4checker_finish<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_DSRD4checker_finishPtr
newCallback_DSRD4checker_finish(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_DSRD4checker_finish<T>(instance, 0, excb, sentcb);
}

template<class T> Callback_DSRD4checker_finishPtr
newCallback_DSRD4checker_finish(T* instance, void (T::*cb)(), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_DSRD4checker_finish<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_DSRD4checker_finishPtr
newCallback_DSRD4checker_finish(T* instance, void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_DSRD4checker_finish<T>(instance, 0, excb, sentcb);
}

template<class T, typename CT>
class Callback_DSRD4checker_finish : public Callback_DSRD4checker_finish_Base, public ::IceInternal::OnewayCallback<T, CT>
{
public:
    ...
    Callback_DSRD4checker_finish(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::OnewayCallback<T, CT>(obj, cb, excb, sentcb)
    {
    }
};

template<class T, typename CT> Callback_DSRD4checker_finishPtr
newCallback_DSRD4checker_finish(const IceUtil::Handle<T>& instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_DSRD4checker_finish<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_DSRD4checker_finishPtr
newCallback_DSRD4checker_finish(const IceUtil::Handle<T>& instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_DSRD4checker_finish<T, CT>(instance, 0, excb, sentcb);
}

template<class T, typename CT> Callback_DSRD4checker_finishPtr
newCallback_DSRD4checker_finish(T* instance, void (T::*cb)(const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_DSRD4checker_finish<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_DSRD4checker_finishPtr
newCallback_DSRD4checker_finish(T* instance, void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_DSRD4checker_finish<T, CT>(instance, 0, excb, sentcb);
}
