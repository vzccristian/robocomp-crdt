...
const ::std::string iceC_RoboCompDSRD4_DSRD4checker_ids[2] =
{
    "::Ice::Object",
    "::RoboCompDSRD4::DSRD4checker"
};
const ::std::string iceC_RoboCompDSRD4_DSRD4checker_ops[] =
{
    "finish",
    "ice_id",
    "ice_ids",
...
const ::std::string iceC_RoboCompDSRD4_DSRD4checker_finish_name = "finish";
...
bool
RoboCompDSRD4::DSRD4checker::ice_isA(::std::string s, const ::Ice::Current&) const
{
    return ::std::binary_search(iceC_RoboCompDSRD4_DSRD4checker_ids, iceC_RoboCompDSRD4_DSRD4checker_ids + 2, s);
}

::std::vector<::std::string>
RoboCompDSRD4::DSRD4checker::ice_ids(const ::Ice::Current&) const
{
    return ::std::vector<::std::string>(&iceC_RoboCompDSRD4_DSRD4checker_ids[0], &iceC_RoboCompDSRD4_DSRD4checker_ids[2]);
}

::std::string
RoboCompDSRD4::DSRD4checker::ice_id(const ::Ice::Current&) const
{
    return ice_staticId();
}

const ::std::string&
RoboCompDSRD4::DSRD4checker::ice_staticId()
{
    static const ::std::string typeId = "::RoboCompDSRD4::DSRD4checker";
    return typeId;
}

bool
RoboCompDSRD4::DSRD4checker::_iceD_finish(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::OperationMode::Normal, current.mode);
    auto istr = inS.startReadParams();
    ::std::string iceP_name;
...
bool
RoboCompDSRD4::DSRD4checker::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_RoboCompDSRD4_DSRD4checker_ops, iceC_RoboCompDSRD4_DSRD4checker_ops + 5, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }

    switch(r.first - iceC_RoboCompDSRD4_DSRD4checker_ops)
    {
        case 0:
        {
...
void
RoboCompDSRD4::DSRD4checkerPrx::_iceI_finish(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<void>>& outAsync, const ::std::string& iceP_name, const ::Ice::Context& context)
{
    outAsync->invoke(iceC_RoboCompDSRD4_DSRD4checker_finish_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        [&](::Ice::OutputStream* ostr)
        {
...
::std::shared_ptr<::Ice::ObjectPrx>
RoboCompDSRD4::DSRD4checkerPrx::_newInstance() const
{
    return ::IceInternal::createProxy<DSRD4checkerPrx>();
}

const ::std::string&
RoboCompDSRD4::DSRD4checkerPrx::ice_staticId()
{
    return RoboCompDSRD4::DSRD4checker::ice_staticId();
}
...
::IceProxy::Ice::Object* ::IceProxy::RoboCompDSRD4::upCast(::IceProxy::RoboCompDSRD4::DSRD4checker* p) { return p; }

void
::IceProxy::RoboCompDSRD4::_readProxy(::Ice::InputStream* istr, ::IceInternal::ProxyHandle< ::IceProxy::RoboCompDSRD4::DSRD4checker>& v)
{
    ::Ice::ObjectPrx proxy;
    istr->read(proxy);
    if(!proxy)
    ...
    {
        v = new ::IceProxy::RoboCompDSRD4::DSRD4checker;
        v->_copyFrom(proxy);
    }
}

::Ice::AsyncResultPtr
IceProxy::RoboCompDSRD4::DSRD4checker::_iceI_begin_finish(const ::std::string& iceP_name, const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_RoboCompDSRD4_DSRD4checker_finish_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_RoboCompDSRD4_DSRD4checker_finish_name, ::Ice::Normal, context);
        ::Ice::OutputStream* ostr = result->startWriteParams(::Ice::DefaultFormat);
        ostr->write(iceP_name);
        result->endWriteParams();
        result->invoke(iceC_RoboCompDSRD4_DSRD4checker_finish_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
void
IceProxy::RoboCompDSRD4::DSRD4checker::end_finish(const ::Ice::AsyncResultPtr& result)
{
    _end(result, iceC_RoboCompDSRD4_DSRD4checker_finish_name);
}

::IceProxy::Ice::Object*
IceProxy::RoboCompDSRD4::DSRD4checker::_newInstance() const
{
    return new DSRD4checker;
}

const ::std::string&
IceProxy::RoboCompDSRD4::DSRD4checker::ice_staticId()
{
    return ::RoboCompDSRD4::DSRD4checker::ice_staticId();
}
...
RoboCompDSRD4::DSRD4checker::~DSRD4checker()
{
}

::Ice::Object* RoboCompDSRD4::upCast(::RoboCompDSRD4::DSRD4checker* p) { return p; }
...
bool
RoboCompDSRD4::DSRD4checker::ice_isA(const ::std::string& s, const ::Ice::Current&) const
{
    return ::std::binary_search(iceC_RoboCompDSRD4_DSRD4checker_ids, iceC_RoboCompDSRD4_DSRD4checker_ids + 2, s);
}
...
RoboCompDSRD4::DSRD4checker::ice_staticId()
{
    ...
    return typeId;
#else
    return iceC_RoboCompDSRD4_DSRD4checker_ids[1];
#endif
}
...
namespace
{
const ::std::string iceC_RoboCompDSRD4_DSRD4checker_all[] =
{
    "finish",
    "ice_id",
    "ice_ids",
...
RoboCompDSRD4::DSRD4checker::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ::std::pair<const ::std::string*, const ::std::string*> r = ::std::equal_range(iceC_RoboCompDSRD4_DSRD4checker_all, iceC_RoboCompDSRD4_DSRD4checker_all + 5, current.operation);
    if(r.first == r.second)
    {
        throw ::Ice::OperationNotExistException(__FILE__, __LINE__, current.id, current.facet, current.operation);
    }

    switch(r.first - iceC_RoboCompDSRD4_DSRD4checker_all)
    {
        case 0:
        {
            return _iceD_finish(in, current);
...
void
RoboCompDSRD4::DSRD4checker::_iceWriteImpl(::Ice::OutputStream* ostr) const
{
    ostr->startSlice(ice_staticId(), -1, true);
    Ice::StreamWriter< ::RoboCompDSRD4::DSRD4checker, ::Ice::OutputStream>::write(ostr, *this);
    ostr->endSlice();
}

void
RoboCompDSRD4::DSRD4checker::_iceReadImpl(::Ice::InputStream* istr)
{
    istr->startSlice();
    Ice::StreamReader< ::RoboCompDSRD4::DSRD4checker, ::Ice::InputStream>::read(istr, *this);
    istr->endSlice();
}

void
RoboCompDSRD4::_icePatchObjectPtr(DSRD4checkerPtr& handle, const ::Ice::ObjectPtr& v)
{
    handle = ::RoboCompDSRD4::DSRD4checkerPtr::dynamicCast(v);
    if(v && !handle)
    {
        IceInternal::Ex::throwUOE(::RoboCompDSRD4::DSRD4checker::ice_staticId(), v);
    }
}
