...
//    example_mvreg();
    ...
    cout << "-------main-------"<<endl;
    ormap<string,aworset<string,string>> m1("dev1"),m2("dev1");
...
//    m1["test4"].add("funciona?");
    ...
    m1["friend"].add("alice","friend");
    m1["primo"].add("paco","primo");
    m1["primo"].add("juan","primo");
    m1["primo"].add("antonio","primo");
    m1["friend"].add("bob","friend");
    m1["tia"].add("juana","tia");
    cout << m1 << endl;
    m1["test4"].add("funciona?","test4");
