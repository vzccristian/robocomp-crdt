...
void SpecificMonitor::readConfig(RoboCompCommonBehavior::ParameterList &params )
{
	...
	aux.editable = true;
	configGetString( "","DSRD4sync.Endpoints", aux.value,"");
    params["DSRD4sync.Endpoints"] = aux;

    configGetString( "","DSRD4syncProxy", aux.value,"");
    params["DSRD4syncProxy"] = aux;

	configGetString( "","id", aux.value,"");
	params["id"] = aux;
}
